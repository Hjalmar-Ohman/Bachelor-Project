...
class Booking(Backend.db.Model):
    ...
    user_id = Backend.db.Column(
        Backend.db.Integer, Backend.db.ForeignKey(Users.User.id)
    )
    tool_id = Backend.db.Column(
        Backend.db.Integer, Backend.db.ForeignKey(Tools.Tool.id)
    )
